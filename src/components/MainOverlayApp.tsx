...
const ConversationFeed = lazy(() => import("@/components/ConversationFeed"));
const ScreenRecordingHud = lazy(() => import("@/components/ScreenRecordingHud"));
...
function MainOverlayApp({ isDarkTheme, onToggleTheme }: MainOverlayAppProps) {
  ...
  const {
    ...
    animate: isUiVisible && !isScreenRecording,
  });
